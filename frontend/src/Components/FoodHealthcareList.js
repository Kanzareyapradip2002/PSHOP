...
const FoodHealthcareList = () => {
    ...
    const fetchCategoryProduct = async () => {
        ...
        try {
            ...
            const filteredCategories = [
                ...dataResponse.data.filter(product => product.category === 'sweet'),
            ];
    ...
    return (
        <>
            ...
            <HorizontalCardProduct category={"sweet"} heaing={"Top's Sweet"} />

        </>
    );
};

export default FoodHealthcareList;
